...
export const projects = [
 ...
 num: "03",
 featured: false,
 title: "Google Drive Integration System",
 subtitle: "Document Sync Platform",
 description: "Seamless integration syncing documents and folders between the application and Google Drive with real-time updates, OAuth authentication, and consistent data state.",
 contributions: [
 "Designed real-time synchronization architecture",
 "Implemented secure OAuth 2.0 authentication and permission handling",
 "Ensured bi-directional data consistency between systems",
 "Built conflict resolution for concurrent edits",
 ],
 impact: [
 "Simplified document management — zero manual uploads",
 "Enabled smooth team collaboration through Drive sync",
 ],
 stack: ["Google APIs", "OAuth 2.0", "Node.js", "MongoDB", "Webhooks"],
 color: colors.amber,
 },
 {
 id: "invoicing",
