...
export const projects = [
 ...
 link: "/invoicing-workflow",
 description: "Fully automated invoice generation pipeline — syncing 2–3K Salesforce contracts daily, running a rule-based engine for 3 invoice types, and managing end-to-end approval workflows.",
 contributions: [
 "Built rule-based engine handling one-time, recurring & usage-based invoices",
 "Designed daily SFDC contract sync and bidirectional push pipeline",
 "Implemented approval chain with rejection/revision workflow",
 "Slab/tier pricing logic for usage-based billing",
 ],
 impact: [
 "Reduced billing cycle from 1–2 weeks to 10–15 minutes",
 "Processes 2–3K contracts per day without manual intervention",
 ],
 stack: ["Node.js", "MongoDB", "Express.js", "Salesforce REST API", "AWS"],
 color: "#a78bfa",
 },
];
