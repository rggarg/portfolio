      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {metrics.map((m, i) => {
            ...
            return (
              <div
                key={m.label}
                className="reveal glass-card rounded-2xl p-7 text-center group hover:border-white/10 transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,255,136,0.04)]"
        ...
        <div className="reveal mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { value: '70%', label: 'API Cost Reduction via Caching', color: 'text-[#a78bfa]' },
            { value: '40%', label: 'Signature Completion Rate Boost', color: 'text-[#f472b6]' },
          ].map((stat, i) => (
            <div
              key={stat.label}
            ...
            >
              <div className={`text-[1.5rem] font-black flex-shrink-0 ${stat.color}`}>{stat.value}</div>
