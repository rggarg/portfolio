import { whatWorked, whatIdoDifferently, futureRoadmap } from '../../data/LegittCLMData';

export default function LegittLearnings() {
  return (
    <section className="py-24 border-t border-border/40">
      <div className="section-container">
        <div className="reveal text-center mb-16">
          <p className="section-label justify-center">Retrospective</p>
          <h2 className="text-heading font-black text-text-main mb-4">Learnings & Future Vision</h2>
          <p className="text-description text-text-dim max-w-2xl mx-auto">
            Honest reflections from 2+ years of building, scaling, and maintaining a production enterprise platform - and where it goes from here.
          </p>
        </div>

        {/* What worked + What I'd do differently */}
        <div className="reveal grid md:grid-cols-2 gap-8 mb-12">
          <div className="glass-card rounded-xl p-7 border-border/60" style={{ borderColor: 'rgba(167,139,250,0.18)' }}>
        ...
        <div className="reveal">
          <h3 className="text-title-sm font-black text-text-main mb-6">Future Roadmap</h3>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {futureRoadmap.map((item, i) => (
              ...
              >
                <div
                  className="text-mini font-bold tracking-widest uppercase mb-2 flex items-center gap-2"
                  style={{ color: '#a78bfa' }}
                >
